...
const PromoCodeSection: React.FC = () => {
  ...
  return (
    <div className="border-t border-gray-300 dark:border-white/50 pt-4 mt-4 relative mb-4">
      <button
      ...
      >
        Apply Promotion Code <ArrowIcon w="24" h="24" isOpen={isPromoCodeDropdownOpen} />
      </button>
