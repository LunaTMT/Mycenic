...
interface ImageGalleryProps {
  images: Image[]; // combined backend images & new uploads
  isEditing: boolean;
...
export default function ImageGallery({
  ...
  // Cleanup object URLs for uploaded files
  useEffect(() => {
        ...
        >
          ...
          <input
            ...
            onChange={(e) => {
              ...
              files.slice(0, remainingSlots).forEach((file) => addImage(file));
              e.target.value = "";
            }}
            className="hidden"
            multiple
      ...
      <DeleteConfirmationModal
        ...
        onConfirm={async () => {
          ...
          try {
            ...
            markImageForDeletion(imageToDelete);
          } catch (err) {
