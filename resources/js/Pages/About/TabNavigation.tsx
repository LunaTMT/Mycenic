...
export default function TabNavigation<T extends string>({
  ...
  return (
    <div className="flex border-b bg-transparent border-gray-300 dark:border-gray-600">
      {tabs.map(({ key, label, icon }, index, arr) => {
        ...
        return (
          <button
            ...
            className={`
              group flex-1 px-6 py-3 text-center font-medium text-lg font-Poppins flex justify-center items-center
              ${borderRadiusClass}
              ${
                isActive
